...
function ScheduleSelectTest({ schedule, day }) {
  const [select, setSelect] = useState(Object.keys(schedule)[0]);
  //   const select = "Test"
  //   console.log(schedule[select][day]["workouts"]);
  const workoutDisplay = () => {
    if (schedule[select][day]["rest"]) {
      return <h1>Today is a rest day</h1>;
    } else {
...
export default ScheduleSelectTest;
